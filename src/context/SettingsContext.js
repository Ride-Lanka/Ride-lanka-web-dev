...
const TRANSLATIONS = {
  en: {
    ...
    guidePortalLabel: "Guide Services",
    tourGuidePortalLabel: "Tour Guide Portal",
    catBeach: "Beach and Relax",
    catHill: "Hill Country",
    catCultural: "Cultural Triangle",
    catNature: "Nature and Wildlife",
  ...
  si: {
    ...
    bookingRequests: "වෙන්කිරීම් ඉල්ලීම්",
    stories: "කතා සහ ලිපි",
    navDiscover: "සොයා බලන්න",
    navTrips: "සංචාර",
    accountLabel: "ඔබේ ගිණුම",
    guidePortalLabel: "මාර්ගෝපදේශ සේවා",
    tourGuidePortalLabel: "සංචාරක මාර්ගෝපදේශක ද්වාරය",
    catBeach: "මුහුදු වෙරළ සහ විවේකය",
    catHill: "කඳුකර ප්‍රදේශය",
    catCultural: "සංස්කෘතික ත්‍රිකෝණය",
    catNature: "ස්වභාවධර්මය සහ වනජීවී",
    catFood: "ආහාර සහ දේශීය ජීවන රටාව",
    catFamily: "පවුලේ අයට හිතකර",
